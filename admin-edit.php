    ...
    */              
    ...
    <body class="text-center">
        ...
        <br /><br />
        <h1 class="mb-4">Article Editor <br /> <a href="add-article.php" class="btn btn-dark"><i class="fa-solid fa-feather" style="color: #ffc107;"></i> Submit an Article</a> <a href="blog.php" class="btn btn-dark"><i class='fa-regular fa-rectangle-list' style="color: #ffc107;"></i> <?php echo $blogbutton; ?></a></h1>
