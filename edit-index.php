...
<body>
    ...
    <br /><br/>
    <h1 class="mx-auto" style="text-align: center;color:white;"><i class="fa-solid fa-code" style="color: #ffc107;"></i>  Edit Homepage <br />
    <a href="<?php echo $websiteUrl; ?>index.php" class="btn btn-dark"><i class="fa-solid fa-home" style="color: #ffc107;"></i> Go to Homepage</a> 
